...
public class ThreadsOfSudoku {
    public static void main(String[] args) {
        ...
        try {
            ...
            int puzzlesPerThread = 81 / numThreads;
            ...
            for (int i = 0; i < numThreads; i++) {
                final int start = i * puzzlesPerThread;
                final int end = (i == numThreads - 1) ? 80 : start + puzzlesPerThread - 1;
                final int threadId = i;

                Thread thread = new Thread(() -> {
                    solveSuds(start, end, threadId);
                });
                thread.start();
                threads.add(thread);
            }
